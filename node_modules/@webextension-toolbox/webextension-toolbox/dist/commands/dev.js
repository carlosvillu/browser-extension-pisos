...
import { compile, logCompileOutput, } from "../common/index.js";
export default async function dev(vendor, options) {
    ...
    if (options.devServer) {
        ...
        const server = new WebpackDevServer({
            static: {
                directory: path.join(process.cwd(), options.target.split("[vendor]").join(vendor)),
            },
            compress: true,
            port: devServerPort,
            devMiddleware: {
